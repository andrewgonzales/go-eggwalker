...
// var (
// 	leftDoc  = fuguemax.NewDoc()
// 	rightDoc = fuguemax.NewDoc()
// 	mu       sync.Mutex
// )
...
// 	leftDoc.LocalInsertText(req.Text, "agent1", uint64(len(leftDoc.StringContent())))
...
// 	rightDoc.LocalInsertText(req.Text, "agent2", uint64(len(rightDoc.StringContent())))
// 	rightDoc.MergeInto(&leftDoc)
// 	leftDoc.MergeInto(&rightDoc)
